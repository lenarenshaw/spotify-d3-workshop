...
async function getAndVisualizeSpotifyData(){
    ...
    $.ajax({
        url: "", // TODO: Replace this with the Spotify API endpoint for getting a user's top tracks.
                 // Feel free to limit these tracks for some max length or other parameters, found in the documentation:
                 // https://developer.spotify.com/documentation/web-api/reference/personalization/get-users-top-artists-and-tracks/
        headers: {}, // TODO: Add header content to request. Reference documentation for fields that are required as well as optional tokens.
